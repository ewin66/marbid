...
namespace Marbid.Module.BusinessObjects.RiskManagement
{
  ...
  public class RiskCategory : BaseObject
  { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
    public RiskCategory(Session session)
      : base(session)
    {
    }
    ...
    public XPCollection<RiskSubCategory> SubCategories
    {
      get
      {
        return GetCollection<RiskSubCategory>("SubCategories");
      }
    }
    [ReadOnly(true)]
