...
{
    public class ASPxNewListEditorControl : Panel, INamingContainer, IXafCallbackHandler
    {
        ...
        public ASPxNewListEditorControl()
        {
    ...
    public class ASPxNewsListEditor : ListEditor
    {
        public ASPxNewsListEditor(IModelListView info) : base(info) { }
        private ASPxNewListEditorControl control;
        protected override object CreateControlsCore()
        {
            control = new ASPxNewListEditorControl();
