...
{
    public class ASPxImageSlideListEditorControl : Panel, INamingContainer, IXafCallbackHandler
    {
        ...
        public ASPxImageSlideListEditorControl()
        {
        ...
        public void Refresh()
        {
            ...
            if (Page != null)
            {
                ...
                //}
                ASPxImageSlider control = new ASPxImageSlider();
                this.Controls.Add(control);
                control.DataSource = dataSource;
                control.TextField = "Title";
                control.ImageContentBytesField = "Cover.MediaData";
                control.SettingsAutoGeneratedImages.EnableImageAutoGeneration = true;
                control.Width = new System.Web.UI.WebControls.Unit("100%");
                control.SettingsImageArea.NavigationButtonVisibility = DevExpress.Web.ElementVisibilityMode.Faded;
                control.SettingsImageArea.ItemTextVisibility = DevExpress.Web.ElementVisibilityMode.Always;
                control.SettingsNavigationBar.Mode = DevExpress.Web.NavigationBarMode.Dots;
                control.SettingsImageArea.ImageSizeMode = DevExpress.Web.ImageSizeMode.FillAndCrop;
                control.NavigateUrlField = "URL";
                control.SettingsImageArea.AnimationType = DevExpress.Web.AnimationType.Auto;
                control.SettingsNavigationBar.ThumbnailsNavigationButtonPosition = DevExpress.Web.ThumbnailNavigationBarButtonPosition.Inside;
                control.SettingsAutoGeneratedImages.ImageCacheFolder = "~\\Images\\";
    ...
    public class ASPxImageSlideListEditor : ListEditor
    {
        public ASPxImageSlideListEditor(IModelListView info) : base(info) { }
        private ASPxImageSlideListEditorControl control;
        protected override object CreateControlsCore()
        {
            control = new ASPxImageSlideListEditorControl();
