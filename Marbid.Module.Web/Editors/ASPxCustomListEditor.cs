      ...
      public void Refresh()
      {
         ...
         if (Page != null)
         {
            ...
            foreach (IPictureItem item in list)
            {
               ...
               //int NewWidth = 250;
               //double NewHeight = ((double)NewWidth / (double)Width) * (double)Height;

               img.Image.AlternateText = item.Text;
               img.Image.Height = item.Image.Height;
               img.Image.Width = item.Image.Width;
